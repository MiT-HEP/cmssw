...
BxToMuMu = cms.EDProducer("BxToMuMuProducer",
    ...
    bdtEvent0 = cms.FileInPath('data/TMVA-100-Events0_BDT.weights.xml'),
    bdtEvent1 = cms.FileInPath('data/TMVA-100-Events1_BDT.weights.xml'),
    bdtEvent2 = cms.FileInPath('data/TMVA-100-Events2_BDT.weights.xml'),
    isMC = cms.bool(False)
)
